...
const T = {
  en: {
    nav_home:"Home", nav_shop:"Shop", nav_contact:"Contact", nav_about:"About Us", nav_join:"Join",
  ...
  th: {
    nav_home:"หน้าแรก", nav_shop:"ร้านค้า", nav_contact:"ติดต่อ", nav_about:"เกี่ยวกับเรา", nav_join:"สมัครสมาชิก",
    ...
    hero_cta_shop:"เข้าร้านค้า", hero_cta_stickers:"ซื้อ LINE Stickers", hero_cta_join:"สมัครสมาชิกช่อง",
    ...
    about_body:"นักแคสเกมและผู้สร้างคอมมูนิตี้ เว็บไซต์นี้รวมคอนเทนต์และสินค้าทางการ ขอบคุณที่สนับสนุน!",
    footer:"© 2025 NosuTakashi สงวนลิขสิทธิ์"
  },
  ja: {
    nav_home:"ホーム", nav_shop:"ショップ", nav_contact:"お問い合わせ", nav_about:"私たちについて", nav_join:"メンバーになる",
...
/* Apply language: อัปเดตข้อความ + ฟอนต์ + lang attribute */
...
/* Simple tabs (#stickers / #apparel) */
function initTabs(){
  const tabs = document.querySelectorAll('.tab');
  if (!tabs.length) return;
  const items = document.querySelectorAll('.product');
  const show = k => items.forEach(it => it.classList.toggle('hidden', it.getAttribute('data-category') !== k));
  tabs.forEach(tab=>{
